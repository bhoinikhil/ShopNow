...
function Kids({product,add}){

     const page = "kids"
    const kidsData = product.filter((stu) => {
    ...
    const sliderImg ={
        img1:"./public/kids/kids1.png",
        img2:"./public/kids/kids2.png",
        img3:"./public/kids/kids3.png"
    }
    return(
        <>
          {/* Carosel */}
